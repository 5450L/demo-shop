...
function MainPage(props) {
    ...
    let productsTemplateArray = props.products.map(product => <ProductCard key={product.id} title={product.title}
                                                                           price={product.price}
    ...
    return (
        <div>
            Products
            <div className={mainPageStyles.products}></div>
            {productsTemplateArray}
        </div>
    );
}
